...
export default function Stories() {
  ...
  const handleVideoPlay = () => {
    if (videoRef.current) {
      videoRef.current.play(); // Check if videoRef.current is not null before calling methods
    }
  };

  const handleVideoPause = () => {
    if (videoRef.current) {
      videoRef.current.pause(); // Check if videoRef.current is not null before calling methods
    }
  };
