...
import card1 from '../../assets/images/—Pngtree—career woman playing laptop on_5315939 1 (1).png'
import card2 from '../../assets/images/—Pngtree—career woman playing laptop on_5315939 1 (2).png'
import card3 from '../../assets/images/—Pngtree—career woman playing laptop on_5315939 1.png'
export default function TopFeature() {
    ...
    return (
        <div className='topFeature '>
            <h3>Our Top Class Features</h3>
            <p>Building Strong Foundations That Empowers Young Mind Unraveling Learning In Our Educational Environment
            </p>
            ...
            <div className="box">
                {cards.map((card, index) => (
                    <div className="card-2" key={index}>
                        ...
                        <div className="para">{card.para}</div>
                        <div className='link'>
